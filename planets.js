...
if (typeof(system.mercury.radiuse) === 'string') {
    system.mercury.radiuse = system.mercury.radiuse
}
...
const differenceInMomentum = jupiterMomentum - plutoMomentum
